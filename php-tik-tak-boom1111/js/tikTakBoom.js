tikTakBoom = {
    ...
    run() {
        ...
        document.querySelector("#btn-2").hidden = false;
        document.querySelector("#btn-2").addEventListener('click', () => this.finish('lose'));
    ...
    turnOn() {
        ...
        this.state = (this.state == document.querySelector("#input").value) ? 1 : this.state + 1;
